...
define(['angular', 'controllers/controllers', 'services/services', 'filters/filters', 'directives/directives'], function (angular) {
    'use strict';
    return angular.module('drip', ['controllers', 'services', 'filters', 'directives', 'ngCookies', 'ngResource', 'ngSanitize', 'ngRoute', 'ui.bootstrap', 'ui.bootstrap.tpls', 'ui.router']).config(['$routeProvider', '$httpProvider', '$provide', '$stateProvider', '$urlRouterProvider', function ($routeProvider, $httpProvider, $provide, $stateProvider, $urlRouterProvider) {
